...
namespace EFCode
{
    public class SubmitRating
    {
        ...
        {
            string connectionString = "Data Source=DESKTOP-4F85292\\SQLEXPRESS;Initial Catalog=UniversityTutoringWebsiteDatabase;Integrated Security=SSPI;MultipleActiveResultSets=true";
